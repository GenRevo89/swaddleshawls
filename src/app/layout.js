  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <meta name="p:domain_verify" content="6591ef82c16d90eb30e9bbd52b688443" />
        {/* Google tag (gtag.js) */}
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-P4GCPZ2V');
            `
          }}
        />
      </head>
      <body className={`${playfair.variable} ${lato.variable} font-sans antialiased min-h-screen flex flex-col`}
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-P4GCPZ2V"
            height="0"
            width="0"
